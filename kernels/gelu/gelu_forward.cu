...
__global__ void gelu_forward_kernel1(const float* input, float* output,
...
__global__ void gelu_forward_kernel2(float* input, float* output, int M,
                                     int N) {
...
__global__ void gelu_forward_kernel3(float* input, float* output, int M,
                                     int N) {
  // each warp handles one row of the input
...
__global__ void gelu_forward_kernel4(float* input, float* output, int M,
                                     int N) {
  using f128 = Package128<float>;
